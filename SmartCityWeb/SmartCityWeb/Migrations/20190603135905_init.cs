...
namespace SmartCityWeb.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HexaDecimalID = table.Column<string>(maxLength: 16, nullable: true),
                    TreeSort = table.Column<string>(nullable: true),
                    GPSLon = table.Column<double>(nullable: false),
                    GPSLan = table.Column<double>(nullable: false),
                    LocationID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TreeID = table.Column<string>(nullable: false),
                    TreeSort = table.Column<string>(nullable: true),
                    NumberOfTrees = table.Column<string>(nullable: true),
                    LocationID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
